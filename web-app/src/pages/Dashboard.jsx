      ...
      <section className="practice-test-section">
        <div className="practice-test-container">
          <div className="practice-test-header">
            <div className="header-content">
              <h2>SIE Practice Test</h2>
              <p>Test your knowledge with our comprehensive 75-question practice exam</p>
            </div>
            
            <Link to="/practice-test" className="primary-button practice-test-button">
              Take Practice Test
            </Link>
          </div>
          
          <div className="practice-test-features">
            <div className="feature-card">
              <div className="feature-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10"></circle>
              ...
              <div className="feature-content">
                <h3>Timed Exam</h3>
                <p>120-minute time limit to simulate real exam conditions</p>
              </div>
            </div>
            ...
            <div className="feature-card">
              ...
              <div className="feature-content">
                <h3>75 Questions</h3>
                <p>Covers all exam topics with realistic questions</p>
              </div>
            </div>
            ...
            <div className="feature-card">
              ...
              <div className="feature-content">
                ...
                <p>Get explanations and review your answers</p>
              </div>
            </div>
          </div>
        </div>
